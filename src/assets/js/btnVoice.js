...
var CircleAudioPlayer = function (options) {
	...
	(function cAPAnimationLoop (now) {
		...
		if (this.animating) {
		 ...
		 if (this._forceDraw || this.playing || this.animating ) {
    // if(timeGral <= 30.0000){ 
...
CircleAudioPlayer.prototype = {
	...
	_draw: function (progress) {
      ...
      myFunction();
      // console.log(timeGral);
       progress =  timeGral / 50.00000 || 0;
      // console.log('progresoo '+ progress);
...
function myFunction() {
    timeGral = timeGral+0.01;             // The function returns the product of p1 and p2
}
